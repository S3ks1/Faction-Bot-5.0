            ...
            getUserByDiscord(user.id).then((res) => {
                if(res === false){
                    ...
                    getUUID(person.ign).then(ress => {
                        ...
                        .addField(`Buffer Checks`, person.bufferchecks, true)
                        .addField(`RPost Checks`, person.rpostchecks, true)
                        .addField(`Last Wall Check`, `${person.wallchecks !== 0 ? ms((ntime-person.lastwallcheck)*1000, { long: true }) : "N/A"} ago`, true)
                        .addField(`Last Buffer Check`, `${person.bufferchecks !== 0 ? ms((ntime-person.lastbuffercheck)*1000, { long: true }) : "N/A"} ago`, true)
                        .addField(`Last RPost Check`, `${person.rpostchecks !== 0 ? ms((ntime-person.lastrpostcheck)*1000, { long: true }) : "N/A"} ago`, true)
                        .setThumbnail(`https://crafatar.com/avatars/${ress.id}.png`, true)
                        message.channel.send(embed)
                    })
